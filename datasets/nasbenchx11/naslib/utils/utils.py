...
""",
    ...
    parser.add_argument("--config-file", default="{}/results/nlp11_0/ptb/configs/nas/config_rs_0.yaml".format(get_project_root()), metavar="FILE", help="path to config file")
