...
class NASBench201API(object):
  ...
  def get_more_info(self, index: int, dataset, iepoch=None, use_12epochs_result=False, is_random=True):
    ...
    if valid_info is not None:
      ...
      xinfo['valid-per-time'] = None if valid_info['all_time'] is None else valid_info['all_time'] / total
    ...
    if test_info is not None:
      ...
      xinfo['test-per-time'] = None if test_info['all_time'] is None else test_info['all_time'] / total
    ...
    if valtest_info is not None:
      ...
      xinfo['valtest-per-time'] = None if valtest_info['all_time'] is None else valtest_info['all_time'] / total
